				...
				>
					<div className="flex items-start gap-4">
						<div className="w-10 h-10 rounded-full bg-red-50 flex items-center justify-center text-red-500 shrink-0 border border-red-100">
							<WarningIcon className="w-5 h-5" weight="bold" />
						</div>
						<div className="flex-1">
							...
							<Dialog.Description className="text-xs text-neutral-500 mt-2 leading-relaxed">
								Are you sure you want to reset this process model? All answers
								will be permanently deleted from the database and all annotation
								shapes will be removed. This action cannot be undone.
							</Dialog.Description>
						</div>
